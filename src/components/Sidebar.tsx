...
import { UserSharp, ImagesSharp, Script, FactorySharp } from 'pixelarticons/react'
  ...
  return (
    <div className='Sidebar'>
        <div className='IconHolder'>
                <SidebarButton content={UserSharp} 
                                name="Users" 
                ...
                <SidebarButton content={FactorySharp} 
                                name="Roles" 
                                description="Roles desc" 
                                onClick={handleButtonClick} 
                                onHover={handleButtonHover}/>
                <SidebarButton content={Script} 
                                name="Commands" 
                                description="Commands desc" 
                                onClick={handleButtonClick} 
                                onHover={handleButtonHover}/>
                <SidebarButton content={ImagesSharp} 
                                name="Sprites" 
